...
const categories: Category[] = [
  ...
  {
    icon: <Lock size={28} />, label: 'Security Infrastructure', color: '#0EA5E9', bg: '/images/ci.jpeg',
    services: [
  ...
  {
    icon: <Radio size={28} />, label: 'Communications Infrastructure', color: '#A78BFA', bg: '/images/si.jpeg',
    services: [
