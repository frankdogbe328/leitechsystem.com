...
export default function Hero({ loaded: _ }: Props) {
  ...
  return (
    ...
    >
      ...
      <div style={{ position:'absolute', top:'18%', left:'7%', width:55, height:55, border:'1.5px solid rgba(245,158,11,0.28)', pointerEvents:'none', zIndex:0, animation:'shape3d 9s linear 0s infinite' }} />
      <div style={{ position:'absolute', top:'72%', left:'6%', width:32, height:32, border:'1.5px solid rgba(245,158,11,0.18)', pointerEvents:'none', zIndex:0, animation:'shape3d 13s linear -3s infinite' }} />
      <div style={{ position:'absolute', top:'18%', right:'7%', width:70, height:70, border:'1.5px solid rgba(14,165,233,0.22)', pointerEvents:'none', zIndex:0, animation:'shape3d 11s linear -5s infinite' }} />
      <div style={{ position:'absolute', top:'68%', right:'9%', width:44, height:44, border:'1.5px solid rgba(16,185,129,0.2)', pointerEvents:'none', zIndex:0, animation:'shape3d 16s linear -8s infinite' }} />
      <div style={{ position:'absolute', top:'45%', left:'3%', width:22, height:22, border:'1px solid rgba(167,139,250,0.25)', pointerEvents:'none', zIndex:0, animation:'shape3d 7s linear -2s infinite' }} />
      <div style={{ position:'absolute', top:'35%', right:'4%', width:28, height:28, border:'1px solid rgba(245,158,11,0.2)', pointerEvents:'none', zIndex:0, animation:'shape3d 10s linear -6s infinite' }} />
