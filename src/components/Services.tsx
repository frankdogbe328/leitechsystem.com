  ...
  return (
    ...
    >
      <div style={{
        ...
        overflow: 'hidden',
        transform: hovered
          ? `rotateX(${tilt.x}deg) rotateY(${tilt.y}deg) translateY(-8px) scale(1.01)`
        ...
        transition: hovered ? 'transform 0.08s linear, box-shadow 0.38s, border-color 0.38s' : 'all 0.55s cubic-bezier(0.22,1,0.36,1)',
        cursor: 'default',
        ...
        {hovered && (
          <div style={{
            position: 'absolute', inset: 0, pointerEvents: 'none', zIndex: 1, borderRadius: 20,
            background: `radial-gradient(circle at ${light.x}% ${light.y}%, rgba(255,255,255,0.07) 0%, transparent 55%)`,
          }} />
        )}
